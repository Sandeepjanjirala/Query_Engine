...
ALL_150_QUESTIONS = [
    ...
    (31, "Show the complete summary of KAKINADA 1 branch.", "branch_scorecard"),
    (32, "Give me all metrics for this branch.", "branch_scorecard"),
    (33, "What is the dropout percentage of KAKINADA 1?", "branch_metric_lookup"),
    (34, "How many students dropped out from KAKINADA 1?", "branch_metric_lookup"),
    (35, "What is the current strength of KAKINADA 1?", "branch_metric_lookup"),
    (36, "What was the previous-year strength of KAKINADA 1?", "branch_metric_lookup"),
    (37, "How many sections does KAKINADA 1 have?", "branch_metric_lookup"),
    (38, "What is the average strength per section at KAKINADA 1?", "branch_metric_lookup"),
    (39, "How many rooms are occupied at KAKINADA 1?", "branch_metric_lookup"),
    (40, "How many empty rooms does KAKINADA 1 have?", "branch_metric_lookup"),
    (41, "What is the staff count at KAKINADA 1?", "branch_metric_lookup"),
    (42, "What is the student-teacher ratio at KAKINADA 1?", "branch_metric_lookup"),
    (43, "Show the dropout and strength details for KAKINADA 1.", "branch_metric_lookup"),
    (44, "Show the room and section details for KAKINADA 1.", "branch_metric_lookup"),
    (45, "Give me the current and previous-year metrics for KAKINADA 1.", "branch_metric_lookup"),
